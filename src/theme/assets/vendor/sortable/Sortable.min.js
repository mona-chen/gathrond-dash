...
!(function (t, e) {
        ...
        if (
          ...
          if (((J = F(l)), (et = F(l, t.draggable)), 'function' == typeof c)) {
            ...
            (c = c.split(',').some(function (t) {
              if ((t = P(s, t.trim(), o, !1)))
                return (
                  W({ sortable: n, rootEl: t, name: 'filter', targetEl: l, fromEl: o, toEl: o }),
                  K('filter', n, { evt: e }),
                  !0
                );
            }))
      ...
      if (at) {
        ...
        if ((z.parentNode[j]._isOutsideThisEl(t), e))
          do {
            if (e[j]) {
              if (
                e[j]._onDragOver({ clientX: at.clientX, clientY: at.clientY, target: t, rootEl: e }) &&
      ...
      if (!U) {
        ...
        k((U = z.cloneNode(!0)), n.ghostClass, !1),
          ...
          R(
            U,
            'transform-origin',
            (ct / parseInt(U.style.width)) * 100 + '% ' + (ut / parseInt(U.style.height)) * 100 + '%',
          );
      }
    },
    ...
    _onDragOver: function (n) {
      ...
      if (!Dt) {
        ...
        if (
          ...
          if (((a = 'vertical' === this._getDirection(n, s)), (o = X(z)), M('dragOverValid'), Rt.eventCanceled))
            return p;
          if (r)
            return (
              (G = q),
      ...
      function A() {
        (tt = F(z)),
          (nt = F(z, e.draggable)),
          W({ sortable: f, name: 'change', toEl: l, newIndex: tt, newDraggableIndex: nt, originalEvent: n });
      }
    },
  ...
  return (
    Rt.mount(
      new (function () {
        function t() {
          for (var t in ((this.defaults = { scroll: !0, scrollSensitivity: 30, scrollSpeed: 10, bubbleScroll: !0 }),
          this))
          ...
          (t.prototype = {
            ...
            clone: function (t) {
              var e = t.sortable,
                ...
                i = t.cancel;
              this.isMultiDrag &&
                (this.options.removeCloneOnHide || (se.length && ie === e && (fe(!0, n), o('clone'), i())));
            },
                ...
                if (!he)
                  if (
                    ...
                    se.splice(se.indexOf(re), 1),
                      (oe = null),
                      N({ sortable: i, rootEl: n, name: 'deselect', targetEl: re, originalEvt: e });
                  else {
                    if (
                      (se.push(re),
                      N({ sortable: i, rootEl: n, name: 'select', targetEl: re, originalEvt: e }),
                      ...
                      if (~f && ~p && f !== p)
                        for (d = f < p ? ((h = f), p) : ((h = p), f + 1); h < d; h++)
                          ~se.indexOf(u[h]) ||
                            ...
                            se.push(u[h]),
                            N({ sortable: i, rootEl: n, name: 'select', targetEl: u[h], originalEvt: e }));
                    } else oe = re;
                    ie = s;
                  }

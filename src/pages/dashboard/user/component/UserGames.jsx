...
const UserGames = ({ user }) => {
  ...
  const { user_games, loading } = useSelector((state) => state.dashboard);

  useEffect(() => {
    dispatch(dashboardAPI.getUserGames({ id: user?.id }));
  }, [user?.id]);
                    ...
                    >
                      <div class="card tournament-card">
                        ...
                        <div class="card-body d-flex justify-content-between">
                          <div>
                            <h6 class="text-primary tournament-label">Cat. ID</h6>
